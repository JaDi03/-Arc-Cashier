...
/**
 * Platform-agnostic Circle Gateway helpers for creator (and admin-as-creator)
 * MetaMask withdrawals. Restored from pre-flatten PeerTube connector modules
 * (commit 6948bc6 gateway-creator.ts). Sidecar never holds creator private keys.
 *
 * Addresses / domain IDs: Circle Gateway Arc Testnet (same values used historically
 * in this repo and in src/ui/paywall.js for Arc USDC).
 */
